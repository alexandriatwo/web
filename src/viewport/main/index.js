          ...
          <div className="row">
            <div className="col-md-6">
              <div className="author-wrap">
                ...
                <div className="row">
                  <div className="col-md-12">
                    <h1 className="heading heading-text first-text rect mb-0">
                      C ore{" "}
                    </h1>{" "}
                    <h1 className="heading heading-text second-text mb-0">
                      {" "}
                      Values
                    </h1>
                    <p className="pe-5">
                ...
                <div className="future-text">
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <button className="gradient-button">read more</button>
                    </div>
                  </div>
                </div>
              </div>
